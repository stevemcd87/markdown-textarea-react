...
it("should display h1 - h6 tags", () => {
  const {
    container
  } = render( /*#__PURE__*/React.createElement(MarkdownTextarea, null));
  let val = {
    h1WithEm: "# *hey1*\n",
    h2WithStrong: "## **hey2**\n",
    h3WithStrongEm: "### ***hey3***\n",
  ...
  expect(container.querySelector(".mtr-h3 .mtr-strong .mtr-em").innerHTML).toBe("hey3");
  expect(container.querySelector(".mtr-h4 .mtr-a").href).toBe("https://google.com/");
...
it("should display a code tag", () => {
  ...
  expect(container.querySelector("code").innerHTML).toBe("<span>var a = [];<br></span><span>var b = 2;<br></span>");
});
...
it("should display all inline tags", () => {
  ...
  fireEvent.change(container.querySelector(".mtr-textarea"), {
    target: {
      value: " * hey-em* hey **hey-strong** hey ***hey-st-em*** [hey](https://www.google.com) 5<sup> 7</sup> 5<sub>6</sub>"
    }
  });
  expect(container.querySelector("em").innerHTML).toBe(" hey-em");
  expect(container.querySelector("strong").innerHTML).toBe("hey-strong");
  expect(container.querySelector("strong em").innerHTML).toBe("hey-st-em");
  expect(container.querySelector(".mtr-a").href).toBe("https://www.google.com/");
